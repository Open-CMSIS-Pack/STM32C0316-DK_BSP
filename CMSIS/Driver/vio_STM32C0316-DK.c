/******************************************************************************
 * @file     vio_STM32C0316-DK.c
 * @brief    Virtual I/O implementation for board STM32C0316-DK
 * @version  V1.0.0
...
/*! \page vio_STM32C0316-DK Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioLED0       | vioSignalOut.0 | LED green       (LD1)| PA5
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTA(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
